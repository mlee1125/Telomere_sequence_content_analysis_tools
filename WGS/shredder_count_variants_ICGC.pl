...
# Initialisations
###########################################
my $max_num_of_threads = 8;	#specifies the number of threads to used for concurrent analysis of files
my $CRITERIA = "4TTAGGGu";	#used for identifying output files from qMotif
my $MIN_READ_LENGTH = 24; 	#post trimming
